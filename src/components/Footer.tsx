...
const Footer = () => (
  <footer className="bg-primary text-primary-foreground">
    <div className="container-main py-16 grid grid-cols-1 md:grid-cols-3 gap-10">
      <div>
        <h3 className="text-xl font-heading font-bold mb-4">Andhra Millets</h3>
      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          {[{ l: "Home", t: "/" }, { l: "About Us", t: "/about" }, { l: "Services", t: "/services" }, { l: "Shop", t: "/shop" }, { l: "Contact", t: "/contact" }].map(i => (
            <Link key={i.t} to={i.t} className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors">{i.l}</Link>
          ))}
        </div>
      </div>
      <div>
